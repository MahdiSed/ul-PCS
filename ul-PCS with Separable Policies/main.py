...
class UPCS():
    ...
    def Setup(self):
        ...
        mpk={'pp':pp, 'CRS1':CRS1, 'CRS2':CRS2, 'vk_sigAS':vk_sigAS, 'vk_sigAR':vk_sigAR, 'ek_encA':ek_encA, 'pp_com':pp_com, 'Gamma1':Gamma1, 'Gamma2':Gamma2}
        return (msk, mpk)
    ...
    def Sign(self,mpk,sk,pk_R,m):
        ...
        if 'dk_encA' in sk[0].keys() and \
            NIZK.verifyProof(self.NIZK,pp,mpk['CRS1'],pk_R['pi'],pk_R['comX'],pk_R['comY'],mpk['Gamma1'])==True and \
            ENC.Dec(self,sk[0]['dk_encA'],pk_R['ct'])==pp['G1']**group.init(ZR, 1) and \
                RangeProof.RanVerify(self.RangeProof ,V, g, h, gs, hs, u, proof,seeds)==True and \
                    Sigma.PRFprove.Verify(pk_R['x_prf'],pk_R['pi_prf'])==1 and \
                        ...
                        pi={'pi':GS_proof, 'comX':GS_comX, 'comY':GS_comY, 'x_prf':x_prf, 'pi_prf':pi_prf, "x_dk":x_dk, "pi_dk":pi_dk}
        else:
